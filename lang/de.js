...
export default {
  ...
  'Change to grid view': 'Wechseln Sie in die Rasteransicht',
  ...
  'Back': 'Zurück',
  'Vue Storefront and BigCommerce': 'Vue Storefront und BigCommerce',
  'Vue Storefront and BigCommerce Demo': 'Vue Storefront und BigCommerce Demo',
  'Demo of Vue Storefront, Lightning-Fast Frontend for Headless Commerce': 'Demo von Vue Storefront, blitzschnelles Frontend für Headless Commerce',
  'Review Title': '{title} ~ {name}',
  'Invalid credentials': 'Ungültiger Ausweis',
  'Our catalogs': 'Unsere Kataloge',
